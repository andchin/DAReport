...
par(mfrow=c(2,2))
qqnorm(Glass.type1[["Si"]], main ="Si in Glass Type 1",pch=19,
       cex.lab=1,cex.main=2)
qqline(Glass.type1[["Si"]],lwd=2,col="red")
qqnorm(Glass.type1[["Fe"]], main ="Fe in Glass Type 1",pch=19,
       cex.lab=1,cex.main=2)
qqline(Glass.type1[["Fe"]],lwd=2,col="red")
qqnorm(Glass.type2[["Ca"]], main ="Ca in Glass Type 2",pch=19,
       cex.lab=1,cex.main=2)
qqline(Glass.type2[["Ca"]],lwd=2,col="red")
qqnorm(Glass.type2[["K"]], main ="K in Glass Type 2",pch=19,
       cex.lab=1,cex.main=2)
qqline(Glass.type2[["K"]],lwd=2,col="red")
@
...
\begin{figure}[h!]
\centering
<<QQsampleslin, eval=TRUE, echo=FALSE, term=FALSE, fig=TRUE, include=FALSE>>=
par(mfrow=c(2,2))
qqnorm(Glass.type1[["Mg"]], main ="Mg in Glass Type 1",pch=19,
       cex.lab=1,cex.main=2)
qqline(Glass.type1[["Mg"]],lwd=2,col="red")
...
@
\caption{Test results of the Shapiro-Wilk test on the whole data sample with ten initial classes}
...
cat(paste("\\end{tabular}", "\n", sep=""))
@
\caption{Test results of the Shapiro-Wilk test on type 1 glass with ten initial classes}
...
cat(paste("\\end{tabular}", "\n", sep=""))
@
\caption{Test results of the Shapiro-Wilk test on type 2 glass with ten initial classes}
...
cat(paste("\\end{tabular}", "\n", sep=""))
@
\caption{Test results of the Shapiro-Wilk test on type 3 glass with ten initial classes}
...
cat(paste("\\end{tabular}", "\n", sep=""))
@
\caption{Test results of the Shapiro-Wilk test on type 5 glass with ten initial classes}
...
cat(paste("\\end{tabular}", "\n", sep=""))
@
\caption{Test results of the Shapiro-Wilk test on type 7 glass with ten initial classes}
